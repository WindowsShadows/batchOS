...
goto fill
:main
call apps\shade_engine\Shade_Engine.bat
echo Press W and S to move, A and D to turn, and press X to quit.
choice /c:wsadx /n /m ""
set x=%cx%
set y=%cy%
if "%errorlevel%"=="1" (
...
if "%errorlevel%"=="5" call "api\exit_app.bat"
goto main
